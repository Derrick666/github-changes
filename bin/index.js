...
var opts = {
  ...
  data: 'commits', // choices: ['pulls', 'commits'] (DEPRECATED)
  branch: 'master',
  tag-name: 'upcoming', //tag name for upcoming release
  token: '', // need to use this for private repos and higher rate limits
  title: 'Change Log', // title to appear in the top of the changelog
  date-format: '(YYYY/MM/DD HH:mm Z)',
  verbose: true, // output details
  host: 'api.github.com', // alternate host name to use with github enterprise
  path-prefix: null, // path-prefix for use with github enterprise
  between-tags: null, // only diff between these two tags, separate by 3 dots ...
  no-merges: true, // do not include merges
  only-merges: true, // only include merges
  only-pulls: true, // only include pull requests
  use-commit-body: true, // use the commit body of a merge instead of the message - "Merge branch..."
  order-semver: true, // use semantic versioning for the ordering instead of the tag date
  reverse-changes: true, // reverse the order of changes within a release (show oldest first)
  hide-tag-names: true, // hide tag names in changelog
};
